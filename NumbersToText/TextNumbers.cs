...
namespace NumbersToText
{
    public static class TextNumbers
    {
        ...
        static public string[] firstHundred = 
        {
        ...
        static public string[] multiples = {
        "", "thousand", "million", "billion", "trillion", "quadrillion", "quintillion"
                                           };

        static public string[] decimalFractions = {
        "tenth", "hundredth", "thousandth", "ten-thousandth"
                                                 };

        // set up array so that denominator of "half" is at position 2, etc.
        static public string[] integralFractions = {
        "", "", "half", "third", "fourth", "fifth", "sixth", "seventh", "eighth",
